...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # Мы используем новый сеанс браузера, тем самым обеспечивая, чтобы никакая информация от Эдит не прошла
        # через данные cookie и пр.
        self.browser.quit()
        self.browser = webdriver.Firefox()
        ...
        # Фрэнси получает уникальный URL-адрес
